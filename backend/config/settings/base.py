"""
Base Django settings for language-learning-platform.
"""
import os
...
STT_PROVIDER = env('STT_PROVIDER', default='local')
...
LOCAL_LLM_BASE_URL = env('LOCAL_LLM_BASE_URL', default='http://localhost:11434')
